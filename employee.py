...
class Employee:
    def __init__(self, name, total_pay,new_total_pay,contract_type,
        ...
        self.new_total_pay = new_total_pay
    ...
    def commission_pay(self):
        ...
        if (self.contract_number != None and self.contract_payment != None):
            self.new_total_pay  += self.contract_number * self.contract_payment
        ...
        if (self.contract_payment != None and self.contract_number == None): #its not bonus
            self.new_total_pay  +=self.contract_payment
        return self.new_total_pay
...
billie = Employee('Billie',4000,0,"salary_contract",None,None,None,None)
print(str(billie))
print(str(billie))
...
charlie = Employee('Charlie',2500,0,"hourly_contract",100,25,None,None)
...
renee = Employee('Renee',3000,0,"salary_contract",None,None,4,200)
...
jan = Employee('Jan',None,0,"hourly_contract",150,25,3,220)
print(jan.__str__())
print(jan.__str__())
print(jan.get_pay())
print(jan.get_pay())
...
robbie = Employee('Robbie',2000,0,"salary_contract",None,None,None,1500)
...
ariel = Employee('Ariel',4200,0,"hourly_contract",120,30,None,600)
print(ariel.__str__())
print(ariel.__str__())
